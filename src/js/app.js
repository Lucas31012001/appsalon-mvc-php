...
function mostrarServicios(servicios){
    servicios.forEach(servicio => {
        const {id, nombre, precio} = servicio; // Extrae las propiedades id, nombre y precio del objeto servicio y las asigna a variables con el mismo nombre
...
function seleccionarServicio(servicio){
    ...
    if(servicios.some(agregado => agregado.id === id)){
        ...
        // Agregarlo
        cita.servicios = [...servicios, servicio]; // Se crea un nuevo array que contiene todos los servicios actuales (servicios) y el nuevo servicio seleccionado
